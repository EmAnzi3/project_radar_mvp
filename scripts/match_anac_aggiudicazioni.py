...
STEP1 = Path("reports/anac_operational_enriched_step1.csv")
AGGIUDICAZIONI_ZIP = Path("data/raw/anac/aggiudicazioni.zip")

OUT = Path("reports/anac_operational_enriched_step2.csv")
OUT_HTML = Path("docs/anac_enriched.html")
...
<head>
  <meta charset="utf-8">
  <title>Project Radar MVP - ANAC enriched</title>
  <style>
    body {{
...
<body>
  <h1>Project Radar MVP - ANAC enriched</h1>
  <div class="meta">
