...
OUT_CSV = Path("reports/national_anac_relevant_awards.csv")
OUT_HTML = Path("docs/national_anac_relevant_awards.html")
OUT_ANOMALIES_CSV = Path("reports/national_anac_awards_anomalies.csv")
OUT_ANOMALIES_HTML = Path("docs/national_anac_awards_anomalies.html")
...
def main():
    ...
    write_awards_html(
        OUT_HTML,
        "Project Radar MVP - National ANAC relevant awards",
        relevant,
    ...
    write_awards_html(
        OUT_ANOMALIES_HTML,
        "Project Radar MVP - National ANAC award anomalies",
        anomalies,
        input_count=len(rows),
        shown_count=500,
