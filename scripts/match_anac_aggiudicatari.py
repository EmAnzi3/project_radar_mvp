...
CIG_TARGETS = Path("reports/anac_cig_targets.csv")
CUP_CIG_SUMMARY = Path("reports/anac_cup_cig_summary.csv")
AGGIUDICATARI_ZIP = Path("data/raw/anac/aggiudicatari.zip")

OUT = Path("reports/anac_cig_aggiudicatari_matches.csv")
OUT_ENRICHED = Path("reports/anac_operational_enriched_step1.csv")
