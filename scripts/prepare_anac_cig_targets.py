...
MATCHES = Path("reports/anac_cup_cig_matches.csv")
TARGETS = Path("reports/anac_cup_targets.csv")

OUT_CIG = Path("reports/anac_cig_targets.csv")
OUT_SUMMARY = Path("reports/anac_cup_cig_summary.csv")
