...
- 2026-09-05 — Il workflow periodico ora genera anche `reports/wind-agent/execution-queue.json` e riporta nel GitHub Step Summary i progetti E4–E7 più urgenti e il numero di scope esecutivi aperti.
